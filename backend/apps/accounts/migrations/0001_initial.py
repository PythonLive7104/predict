    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('source', models.CharField(choices=[('telegram', 'Telegram'), ('web', 'Web')], default='telegram', max_length=16)),
                ('referral_code', models.CharField(default=apps.accounts.models._referral_code, max_length=12, unique=True)),
